...
class Equipment(models.Model):
    ...
    img_link = models.URLField(
        verbose_name="Equipment image link", null=True, blank=True
    )
...
class Injury(models.Model):
    ...
    excluded_workouts = models.ManyToManyField(
        Excercise, verbose_name="Excluded excercises"
    )
    level = models.CharField(max_length=350, verbose_name="Level")
    explaination_video = CloudinaryField(
        verbose_name="Injury Explaination video", null=True, blank=True
    )
    explaination_video_link = CloudinaryField(
        verbose_name="Injury Explaination video", null=True, blank=True
    )
