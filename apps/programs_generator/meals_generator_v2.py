...
""" Generate balanced nutrition plan """
...
def generate_meal_macros(meal_index, meal_food_items, required_macros, number_of_meals):
    ...
    """
    the flow
    1- Compute required macros
    2- Factor out the required main macros and secondary macros
    3- compute main items servings
    4- compute secondary items servings
